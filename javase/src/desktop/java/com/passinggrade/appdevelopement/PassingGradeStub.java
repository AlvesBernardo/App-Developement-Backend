...
package com.passinggrade.appdevelopement;
 ...
 * @author Shai Almog
 */
public class PassingGradeStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "PassingGrade";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new PassingGradeStub());
    }
