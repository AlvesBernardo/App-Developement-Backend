...
object AddExam {
  suspend fun addExam(context: Context, teacherId: Int, courseId: Int, examName: String): Exam {
    val dao = AppDatabase.getDatabase(context).examDao()
    val exam = Exam(idExam = 0, examName = examName, idTeacher = teacherId, idCourse = courseId)
